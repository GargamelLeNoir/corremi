...
public class ActionListenerImpl implements ActionListener, DocumentListener {
	...
	public void actionPerformed(ActionEvent ae) {
		try {
			...
			} else if (ae.getSource() == this.mainWindow.buttonQuit || ae.getSource() == this.mainWindow.menuItemQuit) {
			...
			} else if (ae.getActionCommand().equals(MainWindow.LANGUAGE_CHANGE)) {
				this.mainWindow.translateText();
